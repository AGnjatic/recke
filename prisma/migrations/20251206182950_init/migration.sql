-- CreateEnum
CREATE TYPE "GameType" AS ENUM ('ZIP', 'QUEENS');
...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "linkedinId" TEXT,
    "showInGlobal" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "Score_groupId_userId_game_date_key" ON "Score"("groupId", "userId", "game", "date");
