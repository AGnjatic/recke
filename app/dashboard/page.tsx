...
export default async function Dashboard() {
  ...
  const [groupsResult, invitationsResult, leaderboardResult, currentUser] = await Promise.all([
    getMyGroups(),
  ...
  const globalLeaderboard = "leaderboard" in leaderboardResult ? leaderboardResult.leaderboard : []
